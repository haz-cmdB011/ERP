...
// Copia local del generador de QR que ya usan Calidad y Producción —
// duplicado a propósito para no tocar archivos de otras áreas. Genera el QR
// en el cliente (canvas/data URL); `value` es la URL absoluta de la ficha de
// seguimiento del recibo.
  ...
  return (
    ...
    >
      {dataUrl ? (
        ...
        <img src={dataUrl} alt="Código QR del recibo" width={size} height={size} />
      ) : (
        "QR"
      )}
    </div>
